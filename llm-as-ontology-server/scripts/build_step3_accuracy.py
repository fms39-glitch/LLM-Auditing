#!/usr/bin/env python3
"""
Build step3_accuracy.ipynb for each testing_* folder.
This notebook reads ground truth from Step 1 and LLM predictions from Step 2,
then calculates accuracy metrics.

Since this notebook is LLM-independent (same logic), the same content goes to all 4 folders.
"""
import json
from pathlib import Path

REPO = Path(__file__).resolve().parent.parent
FOLDERS = ["testing_gpt", "testing_claude", "testing_gemini", "testing_deepseek"]
...
def build_cells():
    ...
    # ---- Accuracy Helpers ----
    cells.append(md("## Accuracy Helpers"))
    cells.append(code(
        "# ============================================================\n"
    ...
    # ---- Load Data ----
    cells.append(md("## Load Ground Truth and Predictions"))
    cells.append(code(
        "# ============================================================\n"
        "# Load ground truth\n"
        "# ============================================================\n"
    ...
    # ---- Comparison ----
    cells.append(md("## Compare Predictions vs Ground Truth"))
    cells.append(code(
        "# ============================================================\n"
    ...
    # ---- Summary Tables ----
    cells.append(md("## Accuracy Summary Tables"))
    cells.append(code(
        "# ============================================================\n"
...
def main():
    ...
    for folder in FOLDERS:
        path = REPO / folder / "step3_accuracy.ipynb"
